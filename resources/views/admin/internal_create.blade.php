...
<head>
  ...
  <title>CreateInternal | Admin</title>
   ...
   with font-awesome or any other icon font library -->
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{ route('admin.internal_general') }}" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Internal Event</p>
                  </a>
                </li>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.internal_general') }}">Internal Event</a></li>
      ...
      <section class="content">
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            <form action="{{route('admin.internal_general.store')}}" method="post">
              @csrf
            <div class="card card-outline card-info">
              ...
              <div class="card-body">
                ...
                <input type="hidden" name="page" value="internal">
            ...
            <tbody>
              <tr>
                <td class="project-actions text-right">
                  <button type="submit" class="btn btn-success btn-sm" href="{{route('admin.internal_general.store')}}">
