...
<head>
  ...
  <title> CreateExternal | Admin</title>
      ...
      <section class="content">
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            <form action="{{route('admin.external_general.store')}}" method="post">
              @csrf
            ...
            <tbody>
              <tr>
                <td class="project-actions text-right">
                  <button type="submit" class="btn btn-success btn-sm" href="{{route('admin.external_general.store')}}">
