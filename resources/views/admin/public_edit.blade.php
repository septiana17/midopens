          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.public_general') }}">PublicInformation</a></li>
      ...
      <section class="content">
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            <form action="{{route('admin.public_general.update', $data->id)}}" method="post">
              @csrf
              @method('PUT')
