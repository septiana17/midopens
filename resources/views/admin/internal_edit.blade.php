...
<head>
  ...
  <title>EditInternal | Admin</title>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.internal_general') }}">InternalEvent</a></li>
      ...
      <section class="content">
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            <form action="{{route('admin.internal_general.update', $data->id)}}" method="post">
            @csrf
            @method('PUT')
