...
<head>
  ...
  <title>PublicInformation | Admin</title>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Public Information</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <a class="btn btn-success btn-sm" href="{{ route('admin.public_general.create') }}">
                  ...
                  <tr>
                    ...
                    <td class="project-actions text-right">
                      ...
                      <a class="btn btn-info btn-sm"
                        href="{{ route('admin.public_general.edit', $content->id) }}">
