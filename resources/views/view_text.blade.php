    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
          ...
          <li class="nav-item"><a class="nav-link active" href="#">Internal Event</a></li>
  ...
  <section class="page-section bg-light">
    <div class="container">
      ...
      <div class="row gy-3 my-3">
        ...
        <!-- Center col -->
        <section class="col-lg-7" style="padding-top: 5px; padding-bottom: 5px">
          <div class="text">
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, cumque, eveniet maxime
              culpa ducimus quia doloribus blanditiis voluptatum nostrum soluta inventore impedit.
              Exercitationem, dolorum! Impedit corrupti, eius reiciendis ipsa ea pariatur explicabo alias,
              sequi iste non eligendi minus quasi? Consequatur vel exercitationem quod, eos consectetur
              rerum eaque deserunt blanditiis a molestiae sunt rem quaerat architecto inventore nobis
              saepe provident minima quidem repudiandae eius culpa nam sit expedita! Officia minima
              obcaecati tempore at esse assumenda quibusdam sint? Perferendis dicta, consequuntur ex eaque
              ab numquam! Aliquid sint ab deleniti beatae nihil, praesentium earum architecto harum
              minima, explicabo eos deserunt at? Deserunt voluptas vitae unde odit esse sequi ullam.
              Deleniti qui aliquam ipsam mollitia eaque quibusdam excepturi dicta quos repellat provident!
              Laudantium laborum, quia aliquid eligendi veniam reprehenderit accusamus quos. Unde commodi
              odit eos officiis? Ad tempora quisquam ullam reprehenderit modi corporis doloremque
              molestias nostrum fugiat vero laudantium ducimus placeat deleniti omnis dolorem autem fugit
              possimus, quis recusandae earum! Placeat eaque, assumenda ipsa quasi officiis debitis
              impedit atque. Impedit, error, sequi voluptatibus animi nihil dicta accusantium obcaecati
              officiis est minus tempore eum nemo qui consequuntur alias laudantium excepturi porro amet
              molestias numquam rerum cumque, ullam harum? Tempore odit corrupti molestiae repellendus!
              Perferendis, excepturi!</p>
          </div>
        </section>
